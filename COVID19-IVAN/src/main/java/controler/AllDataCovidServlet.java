...
/**
 * Clase utlizada para devolver todos los valores del covid
 * 
 * @author @kalua66
 *
 */
@WebServlet("/allcovid")
public class AllDataCovidServlet extends HttpServlet 
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		try 
		{
			List<Covid> listCovid = covidDAO.getAllCovid();
			session.setAttribute("listCovid",listCovid);
		}
