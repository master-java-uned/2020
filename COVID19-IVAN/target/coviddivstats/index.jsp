            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                                ...
                                <div class="card mb-4">
                                    <div class="card-header">
										...
										<div style="display: inline-block;float:right;">
											<span id="actualDay"></span>
											<div onclick="setvalue1();" class="button-map">+1 day</div>
											<div onclick="setvalue2();" class="button-map" style="display:none;">last day</div>
											<div onclick="setvalue3();" class="button-map">first day</div>
											<div onclick="setvalue4();" class="button-map">Play animation</div>
										</div>
                        ...
                        <div class="card mb-4">
                            <div class="card-header"><i class="fas fa-table mr-1"></i> Countries ( 20 <i class="fas fa-long-arrow-alt-up"></i> Confirmed)</div>
                            <div class="card-body">
                                <div class="table-responsive">
                                
                                      <table:covid><span></span></table:covid>
